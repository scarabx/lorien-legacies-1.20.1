...
public class IciclesEntity extends Entity implements Ownable {
    ...
    public IciclesEntity(EntityType<? extends IciclesEntity> entityType, World world) {
        super(entityType, world);
    }

    public IciclesEntity(World world, double x, double y, double z, float yaw, int warmup, LivingEntity owner) {
        this(ModEntities.ICICLES, world);
        this.warmup = warmup;
        this.setOwner(owner);
