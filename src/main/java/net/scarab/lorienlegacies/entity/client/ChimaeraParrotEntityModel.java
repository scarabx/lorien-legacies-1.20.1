...
public class ChimaeraParrotEntityModel extends SinglePartEntityModel<ChimaeraParrotEntity> {
    /**
    ...
    public ChimaeraParrotEntityModel(ModelPart root) {
        this.root = root;
    ...
    public void setAngles(ChimaeraParrotEntity chimaeraParrotEntity, float f, float g, float h, float i, float j) {
        this.setAngles(getPose(chimaeraParrotEntity), chimaeraParrotEntity.age, f, g, h, i, j);
    }

    public void animateModel(ChimaeraParrotEntity chimaeraParrotEntity, float f, float g, float h) {
        this.animateModel(getPose(chimaeraParrotEntity));
    }
    ...
    public void poseOnShoulder(
        ...
        this.animateModel(ChimaeraParrotEntityModel.Pose.ON_SHOULDER);
        this.setAngles(ChimaeraParrotEntityModel.Pose.ON_SHOULDER, danceAngle, limbAngle, limbDistance, 0.0F, headYaw, headPitch);
        this.root.render(matrices, vertexConsumer, light, overlay);
    }

    private void setAngles(ChimaeraParrotEntityModel.Pose pose, int danceAngle, float limbAngle, float limbDistance, float age, float headYaw, float headPitch) {
    ...
    private void animateModel(ChimaeraParrotEntityModel.Pose pose) {
    ...
    private static ChimaeraParrotEntityModel.Pose getPose(ChimaeraParrotEntity chimaeraParrotEntity) {
        if (chimaeraParrotEntity.isSongPlaying()) {
            return ChimaeraParrotEntityModel.Pose.PARTY;
        } else if (chimaeraParrotEntity.isInSittingPose()) {
            return ChimaeraParrotEntityModel.Pose.SITTING;
        } else {
            return chimaeraParrotEntity.isInAir() ? ChimaeraParrotEntityModel.Pose.FLYING : ChimaeraParrotEntityModel.Pose.STANDING;
        }
    }
