...
import static net.scarab.lorienlegacies.effect.ModEffects.TOGGLE_XIMIC_TELEKINESIS;

public class ToggleXimicTelekinesisEffect extends StatusEffect {

    public ToggleXimicTelekinesisEffect(StatusEffectCategory category, int color) {
    ...
    public static void toggleXimicTelekinesis(ServerPlayerEntity player) {

        if (player.hasStatusEffect(TOGGLE_XIMIC_TELEKINESIS)) {
