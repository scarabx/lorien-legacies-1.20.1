...
public class ToggleNovisEffect extends StatusEffect {

    public ToggleNovisEffect(StatusEffectCategory category, int color) {
    ...
    public static void toggleNovis(ServerPlayerEntity player) {
