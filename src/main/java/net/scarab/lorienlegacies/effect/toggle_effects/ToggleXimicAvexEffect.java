...
import static net.scarab.lorienlegacies.effect.ModEffects.TOGGLE_XIMIC_AVEX;

public class ToggleXimicAvexEffect extends StatusEffect {

    public ToggleXimicAvexEffect(StatusEffectCategory category, int color) {
    ...
    public static void toggleXimicAvex(ServerPlayerEntity player) {

        if (player.hasStatusEffect(TOGGLE_XIMIC_AVEX)) {
