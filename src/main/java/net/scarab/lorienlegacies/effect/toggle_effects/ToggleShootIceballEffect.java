...
public class ToggleShootIceballEffect extends StatusEffect {

    public ToggleShootIceballEffect(StatusEffectCategory category, int color) {
    ...
    public static void toggleShootIceball(ServerPlayerEntity player) {
