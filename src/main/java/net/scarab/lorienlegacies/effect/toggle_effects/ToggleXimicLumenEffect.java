...
import static net.scarab.lorienlegacies.effect.ModEffects.TOGGLE_XIMIC_LUMEN;

public class ToggleXimicLumenEffect extends StatusEffect {

    public ToggleXimicLumenEffect(StatusEffectCategory category, int color) {
    ...
    public static void toggleXimicLumen(ServerPlayerEntity player) {

        if (player.hasStatusEffect(TOGGLE_XIMIC_LUMEN)) {
