...
import static net.scarab.lorienlegacies.effect.ModEffects.TOGGLE_XIMIC_NOXEN;

public class ToggleXimicNoxenEffect extends StatusEffect {

    public ToggleXimicNoxenEffect(StatusEffectCategory category, int color) {
    ...
    public static void toggleXimicNoxen(ServerPlayerEntity player) {

        if (player.hasStatusEffect(TOGGLE_XIMIC_NOXEN)) {
