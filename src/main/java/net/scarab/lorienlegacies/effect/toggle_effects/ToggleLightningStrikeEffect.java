...
import static net.scarab.lorienlegacies.effect.ModEffects.TOGGLE_LIGHTNING_STRIKE;

public class ToggleLightningStrikeEffect extends StatusEffect {

    public ToggleLightningStrikeEffect(StatusEffectCategory category, int color) {
    ...
    public static void toggleLightningStrike(ServerPlayerEntity player) {
