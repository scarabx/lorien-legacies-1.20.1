...
import static net.scarab.lorienlegacies.effect.ModEffects.TOGGLE_XIMIC_PONDUS;

public class ToggleXimicPondusEffect extends StatusEffect {

    public ToggleXimicPondusEffect(StatusEffectCategory category, int color) {
    ...
    public static void toggleXimicPondus(ServerPlayerEntity player) {

        if (player.hasStatusEffect(TOGGLE_XIMIC_PONDUS)) {
