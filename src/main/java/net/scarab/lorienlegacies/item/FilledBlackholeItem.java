...
public class FilledBlackholeItem extends Item {

    public FilledBlackholeItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ...
            FilledBlackHoleEntity entity = new FilledBlackHoleEntity(ModEntities.FILLED_BLACK_HOLE, world);
